...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const adminNavGroups = [
    ...
    },
    {
      ...
      items: [
        { href: '/admin/plans', label: 'Solar Plan Management', icon: Layers },
        { href: '/admin/settings', label: 'Solar Operation Settings', icon: Clock },
        { href: '/admin/units', label: 'Active Units Fleet', icon: Sun },
        { href: '/admin/panel-images', label: 'Panel Assets Manager', icon: Sparkles },
      ],
    },
    {
      label: 'FINANCIAL DESK',
      items: [
        { href: '/admin/recharges', label: 'Recharges Desk', icon: DollarSign },
    ...
    {
      label: 'USER MANAGEMENT & GOVERNANCE',
      items: [
        { href: '/admin/users', label: 'All Users (360°)', icon: Users },
        { href: '/admin/security/sessions', label: 'Sessions & Security', icon: Lock },
        { href: '/admin/broadcasts', label: 'Broadcast Dispatch', icon: Radio },
