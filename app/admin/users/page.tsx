                ...
                <tr key={u.id} className="hover:bg-white/[0.02] transition-colors">
                    ...
                    <span
                      className={`px-2 py-0.5 rounded-lg text-[10px] font-bold border ${
                        u.role === 'SUPER_ADMIN'
                          ...
                          : 'bg-solar-blue/20 text-solar-blue border-solar-blue/40'
                      }`}
                    >
                      {u.role}
                    </span>
                  </td>
                  <td className="p-4 text-slate-300">{u.leadershipLevel.replace('_', ' ')}</td>
                  <td className="p-4">
                    <span className="font-bold text-solar-gold font-mono-num">{u.points} PTS</span>
                  </td>
                  ...
                  <td className="p-4 text-right space-x-2">
                    <button
                      ...
                      title="Adjust Points"
                    >
                      <Sparkles className="w-3 h-3" /> Adjust Pts
                    </button>
                    <button
