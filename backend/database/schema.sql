...
-- ============================================================================
-- ATOMIC BALANCE MANAGEMENT STORED FUNCTIONS (Row-Level Locking)
-- ============================================================================
...
CREATE OR REPLACE FUNCTION credit_user_balance(p_user_id UUID, p_amount NUMERIC, p_total_earned_delta NUMERIC DEFAULT 0)
RETURNS TABLE (
  success BOOLEAN,
  balance_before NUMERIC,
  balance_after NUMERIC,
...
-- ============================================================================
-- DIRECT-SELLING & COMPLIANT MLM TABLES
-- ============================================================================
