...
// ============================================================================
// DIRECT-SELLING & COMPLIANT MLM TYPES
// ============================================================================
...
export type DirectCommissionStatus = 'PENDING' | 'APPROVED' | 'PAID' | 'CLAWED_BACK';

export interface DirectCommission {
  id: string;
  orderId: string;
  orderNo?: string;
...
export type PayoutMethodType = 'USDT_TRC20' | 'USDT_BEP20' | 'BANK_WIRE';
